...
{ path : 'collegecreate', loadChildren: () => import('./collegecreate/collegecreate.module').then(m => m.CollegecreateModule), canActivate: [AuthGuard] } , 
{ path : 'studentall', loadChildren: () => import('./studentall/studentall.module').then(m => m.StudentallModule), canActivate: [AuthGuard] } , 
{ path : 'collegegetall', loadChildren: () => import('./collegegetall/collegegetall.module').then(m => m.CollegegetallModule), canActivate: [AuthGuard] } , 
];
